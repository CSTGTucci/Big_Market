...
public class CreditAdjustServiceTest {
    ...
    public void test_createOrder_forward() {
        ...
        tradeEntity.setUserId("test_B");
        tradeEntity.setTradeName(TradeNameVO.REBATE);
        tradeEntity.setTradeType(TradeTypeVO.FORWARD);
        tradeEntity.setAmount(new BigDecimal("10.00"));
    ...
    public void test_createOrder_reverse() {
        ...
        tradeEntity.setAmount(new BigDecimal("-20.00"));
        tradeEntity.setOutBusinessNo("200009900001");
        creditAdjustService.createOrder(tradeEntity);
    }
    @Test
    public void test_createOrder_pay() throws InterruptedException {
        ...
        tradeEntity.setOutBusinessNo("80009240609002");
        creditAdjustService.createOrder(tradeEntity);
